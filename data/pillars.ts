...
export const budgetLine =
  "ご予算が決まっている場合は、先にお聞かせください。その範囲で、現実的にできることをお出しします。";
...
export const stanceFull = [
  ...
  "AIで作った時間は、経営者の方と未来の話をする時間に使いたい。自分と、その周りが幸せになる。AIで、もっと良い未来を作る。そのために、狭く、深く。",
];

/** 04 人 に置く姿勢の宣言（トップ用）。全文は /about
 *  2026-09-21 あおき指摘＝短い句だけでは「端折りすぎて何を言っているか分からない」
 *  →短い句は見出しとして残し、意味が分かる説明を1〜2文ずつ添える（出どころは stanceFull）。
 *  「説明会も、セミナーも」は 01 の notDoing で言っているので、ここでは繰り返さない */
export const stanceItems = [
  {
    title: "数字で話します。",
    body: "判断は、すべて数字で行います。お見せするのは、実際の業務で計測した数字だけです。",
  },
  {
    title: "狭く、深く。",
    body: "多くの会社を広く回ることはしません。一人で御社の中の深いところまで入り、社員の方が自分で回せる状態になるまで伴走します。",
  },
  {
    title: "浮いた時間は、未来の話に。",
    body: "AIで作業が速くなれば、時間が生まれます。その時間を、経営者の方と、これからの御社の話をすることに使いたいと考えています。",
  },
];
